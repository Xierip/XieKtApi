...
import pl.xierip.xieapi.objects.CustomBossBar;
...
public class BossBarAPI {
    ...
    public static void setMessage(Player player, BarColor barColor, BarStyle barStyle, String title, int time, BarFlag... barFlags) {
        removeBar(player);
        final int[] currentTime = {time};
        BossBar bossBar = Bukkit.createBossBar(StringUtil.fixColors(title), barColor, barStyle, barFlags);
    ...
    public static void setMessage(Player player, BarColor barColor, BarStyle barStyle, String title, BarFlag... barFlags) {
        removeBar(player);
        BossBar bossBar = Bukkit.createBossBar(StringUtil.fixColors(title), barColor, barStyle, barFlags);
        bossBar.addPlayer(player);
        bossBar.setVisible(true);
