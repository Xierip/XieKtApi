...
import pl.xierip.xieapi.managers.CustomItemsManager;
import pl.xierip.xieapi.XieAPI;
import pl.xierip.xieapi.enums.LogType;
import pl.xierip.xieapi.utils.*;
        ...
        if (!yamlConfiguration.isSet(path)) {
            ...
            if (!yamlConfiguration.isSet(path + ".id")) {
                ...
                try {
                    ...
                    int amount = 1;
                    if (yamlConfiguration.isSet(path + ".amount") && yamlConfiguration.isInt(path + ".amount")) {
                    ...
                    String name = null;
                    if (yamlConfiguration.isSet(path + ".name") && yamlConfiguration.isString(path + ".name")) {
                        name = this.getColoredString(path + ".name");
                    }
                    final Map<Enchantment, Integer> enchantments = new HashMap<>();
                    if (yamlConfiguration.isSet(path + ".enchants") && yamlConfiguration.isConfigurationSection(path + ".enchants")) {
