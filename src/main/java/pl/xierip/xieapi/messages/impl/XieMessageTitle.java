...
public class XieMessageTitle implements XieMessage {
  ...
  public void sendMessage(CommandSender commandSender, String... replace) {
    if (commandSender instanceof Player) {
      Title title = new Title(StringUtil.replace(StringUtil.fixColors(titleString), replace),
          StringUtil.replace(StringUtil.fixColors(subTitleString), replace), in, stay, out);
