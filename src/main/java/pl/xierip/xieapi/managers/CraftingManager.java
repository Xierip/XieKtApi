...
import pl.xierip.xieapi.utils.Parsers;
...
public class CraftingManager {
    ...
    public static void registerCrafting(final Config config, final String path, final String name, ItemStack item) {
        final ShapedRecipe shape = new ShapedRecipe(new NamespacedKey(XieAPI.getInstance(), "XieAPI" + name), item);
