...
public class LocationUtil {
  ...
  public static String coloredLocation(final Location location) {
    return "&7X: &9" + location.getBlockX() + " &7Y: &9" + location.getBlockY() + " &7Z: &9"
        + location.getBlockZ();
  }
  ...
  public static String locationToString(final Location location) {
    return "X: " + location.getBlockX() + " Y: " + location.getBlockY() + " Z: " + location
        .getBlockZ() + " World: " + location.getWorld().getName();
  }
}
