...
public class PacketUtil {
    public static PacketContainer buildTeamPacket(String name, String display, int flag, String... members) {
        PacketContainer packet = XieAPI.getProtocolManager().createPacket(PacketType.Play.Server.SCOREBOARD_TEAM);
